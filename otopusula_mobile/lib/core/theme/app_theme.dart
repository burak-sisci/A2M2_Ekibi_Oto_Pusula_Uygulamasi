...
class AppTheme {
  ...
  static ThemeData get light => ThemeData(
    ...
    cardTheme: CardThemeData(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(AppConstants.radiusCard.toDouble()),
    ...
    dividerTheme: const DividerThemeData(color: AppColors.border, space: 1.0),
  );
  ...
  static ThemeData get dark => ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(AppConstants.radiusCard.toDouble()),
        borderSide: const BorderSide(color: AppColors.primaryDarkMode, width: 2.0),
      ),
      labelStyle: const TextStyle(color: AppColors.textSecondaryDarkMode, fontSize: 13.0),
      hintStyle: const TextStyle(color: AppColors.textSecondaryDarkMode, fontSize: 13.0),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
    ...
    dividerTheme: const DividerThemeData(color: AppColors.borderDarkMode, space: 1.0),
  );
}