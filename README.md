...
*(Not: Proje geliştirme aşamasında olduğu için linkler lokal ortamı temsil etmektedir)*

- **Auth Service (Kimlik):** `http://localhost:5001`
- **Listing Service (İlanlar):** `http://localhost:5002`
- **AI Service (Fiyat Tahmin):** `http://localhost:5000`
